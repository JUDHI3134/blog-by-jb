          ...
          <div className='bg-white max-w-3xl w-full p-4 md:p-10 sm:m-10 shadow rounded'>
              ...
              <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
                  ...
                  {loading && (
                      ...
                      <div className='w-6 h-6 rounded-full border-2 border-t-white animate-spin'></div>
                    </div>)}
              ...
              <select name="category" onChange={(e) => setCategory(e.target.value)} value={category} className='mt-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded'>
              ...
              <button disabled={isAdding} type="submit" className='mt-8 w-40 h-10 bg-primary text-white cursor-pointer rounded text-sm'>{isAdding ? 'Adding...' : 'Add Blog'}</button>
